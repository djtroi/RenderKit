...
Current repository version: **1.1.8**. RenderKit supports **Windows PowerShell 5.1** and **PowerShell 7+**.
...
command exported by the 1.1.8 manifest. Detailed workflow documentation is
