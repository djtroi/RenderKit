Register-RenderKitFunction "Add-MetadataTemplateField"
function Add-MetadataTemplateField {
    ...
    process {
        ...
        if (-not $PSCmdlet.ShouldProcess($Name, "Add metadata template field '$field'")) {
            return
        }
